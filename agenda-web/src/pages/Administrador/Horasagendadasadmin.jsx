...
function HorasAgendadasAdmin() {
    ...
    const fetchAdminDetails = async () => {
        try {
            ...
            const response = await fetch('http://localhost:5000/api/obtener_cuentas', {
                method: 'GET',
                headers: {
            ...
            if (response.ok) {
                ...
                if (data.cuentas && data.cuentas.length > 0) {
                    setAdminName(data.cuentas[0].nombre);
                }
            }
        } catch (error) {
                    ...
                    {Object.keys(dayAppointments).length > 0 ? (
                        <div>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {selectedService && dayAppointments[selectedService].map((appointment, index) => (
                                    <div
                                        key={index}
